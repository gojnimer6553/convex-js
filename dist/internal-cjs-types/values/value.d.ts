 ...
 * @public
 */
export type Value = null | bigint | number | boolean | string | ArrayBuffer | CommitTsPlaceholder | Value[] | {
 ...
 * @public
 */
export declare class CommitTsPlaceholder {
    private readonly __isCommitTsPlaceholder;
 ...
 * @internal
 */
export declare const commitTsPlaceholder: CommitTsPlaceholder;
