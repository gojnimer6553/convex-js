...
export declare class PaginatedQueryClient {
    ...
    constructor(client: BaseConvexClientInterface, onTransition: (transition: ExtendedTransition) => void);
    /**
     ...
     * @internal
     */
    localQueryResultByToken(token: PaginatedQueryToken): AnyPaginatedQueryResult | undefined;
