...
import { QueryJournal, RequestId, TS, UserIdentityAttributes } from "./protocol.js";
...
export declare class BaseConvexClient {
     ...
     * @internal
     */
    mutationInternal(udfPath: string, args?: Record<string, Value>, options?: MutationOptions, componentPath?: string): Promise<FunctionResult>;
    /**
     * @internal
     */
    enqueueMutation(udfPath: string, args?: Record<string, Value>, options?: MutationOptions, componentPath?: string): {
        requestId: RequestId;
