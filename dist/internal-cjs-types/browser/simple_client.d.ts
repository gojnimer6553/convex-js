...
import { ExtendedTransition, PaginatedQueryClient } from "./sync/paginated_query_client.js";
...
export declare class ConvexClient {
     ...
     */
    onPaginatedUpdate_experimental<Query extends FunctionReference<"query">>(query: Query, args: FunctionArgs<Query>, options: {
        initialNumItems: number;
    }, callback: (result: PaginationResult<FunctionReturnType<Query>>) => unknown, onError?: (e: Error) => unknown): Unsubscribe<PaginatedQueryResult<FunctionReturnType<Query>[]>>;
    private callNewListenersWithCurrentValues;
    private queryResultReady;
    private createDisabledUnsubscribe;
    close(): Promise<void>;
    /**
     ...
     * @internal
     */
    _transition({ queries, paginatedQueries, }: Pick<ExtendedTransition, "queries" | "paginatedQueries">, callNewListeners?: boolean): void;
    /**
