 ...
 * @module
 */
export type { Auth, AuthConfig, AuthProvider, UserIdentity, UserIdentityAttributes, } from "./authentication.js";
...
export type { TransactionMetric, TransactionMetrics, TransactionLimits, FunctionMetadata, DeploymentMetadata, RequestMetadata, QueryMeta, MutationMeta, ActionMeta, } from "./meta.js";
...
export type { SystemFields, IdField, WithoutSystemFields, WithOptionalSystemFields, SystemIndexes, IndexTiebreakerField, } from "./system_fields.js";
...
export { defineApp, defineComponent, componentsGeneric, createFunctionHandle, type AnyChildComponents, type EnvDefinition, type EnvFromDefinition, type EnvFromAppDefinition, type AppDefinition, } from "./components/index.js";
/**
 * @internal
 */
...
export type { VectorSearch, VectorSearchQuery, VectorFilterBuilder, FilterExpression, } from "./vector_search.js";
/**
 * @public
 */
