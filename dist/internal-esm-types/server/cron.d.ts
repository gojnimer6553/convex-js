...
export declare class Crons {
    ...
    constructor();
    /** @internal */
    schedule(cronIdentifier: string, schedule: Schedule, functionReference: SchedulableFunctionReference, args?: Record<string, Value>): void;
    /**
     ...
     * @param args - The arguments to the function.
     */
    hourly<FuncRef extends SchedulableFunctionReference>(cronIdentifier: string, functionReference: FuncRef, ...args: OptionalRestArgs<FuncRef>): void;
