...
export type { BaseConvexClientOptions, MutationOptions, SubscribeOptions, ConnectionState, AuthTokenFetcher, } from "./sync/client.js";
/** @internal */
...
export type { OptimisticUpdate, OptimisticLocalStore, } from "./sync/optimistic_updates.js";
