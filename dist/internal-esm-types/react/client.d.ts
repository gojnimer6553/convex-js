...
import { AuthTokenFetcher, BaseConvexClientOptions, ConnectionState, BaseConvexClientInterface } from "../browser/sync/client.js";
...
import { PaginatedQueryClient } from "../browser/sync/paginated_query_client.js";
/**
...
export declare class ConvexReactClient {
     ...
     */
    prewarmQuery<Query extends FunctionReference<"query">>(queryOptions: QueryOptions<Query> & {
     ...
     * @internal
     */
    watchPaginatedQuery<Query extends FunctionReference<"query">>(query: Query, args: Query["_args"], options: WatchPaginatedQueryOptions): PaginatedWatch<FunctionReturnType<Query>>;
    /**
...
type UseQueryOptions<Query extends FunctionReference<"query">, ThrowOnError extends boolean> = {
    query: Query;
 ...
 * @public
 */
export declare function useQuery_experimental<Query extends FunctionReference<"query">, ThrowOnError extends boolean = false>(options: UseQueryOptions<Query, ThrowOnError>): UseQueryResult<Query["_returnType"], ThrowOnError>;
/**
