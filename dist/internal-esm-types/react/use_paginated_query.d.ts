...
import { FunctionReturnType, PaginationOptions, paginationOptsValidator, PaginationResult } from "../server/index.js";
import { Infer, Value } from "../values/index.js";
...
/** @internal */
export declare const includePage: unique symbol;
/** @internal */
export declare const page: unique symbol;
/**
 * @internal
 */
export declare function usePaginatedQueryInternal<Query extends PaginatedQueryReference>(query: Query, args: PaginatedQueryArgs<Query> | "skip", options: {
    initialNumItems: number;
    [includePage]?: boolean;
}, throwOnError?: boolean): {
    user: UsePaginatedQueryInternalResult<PaginatedQueryItem<Query>>;
    internal: {
        state: UsePaginatedQueryState;
    };
};
/**
 ...
 * @internal
 */
export type UsePaginatedQueryInternalResult<Item> = UsePaginatedQueryResult<Item> | {
    results: Item[];
    status: "Error";
    isLoading: false;
    error: Error;
